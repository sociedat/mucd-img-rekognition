...
## Cuántas imagenes quedaron fuera una vez aplicados los filtros de confianza >= `{r param}` %, el filtro de diccionario de etiquetas militares, y el filtro de etiquetas de contacto con la sociedad?
